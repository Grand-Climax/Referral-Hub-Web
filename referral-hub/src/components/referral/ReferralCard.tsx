...
//   const timeAgo = formatDistanceToNow(new Date(referral.created_at), { addSuffix: true });
...
//             </div>
//             <h3 className="font-semibold text-foreground truncate">{referral.patient?.first_name + " " + referral.patient?.last_name}</h3>
//           </div>
//           <PriorityIndicator severity={referral.severity} score={referral.severity} compact={compact} />
//         </div>
//       </CardHeader>
